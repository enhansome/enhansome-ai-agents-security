...
* **[AgentGateway](https://github.com/agentgateway/agentgateway) ⭐ 4,505 | 🐛 341 | 🌐 Rust | 📅 2026-08-24** - A Linux Foundation project providing an AI-native proxy for secure connectivity (A2A & MCP protocols). It adds RBAC, observability, and policy enforcement to agent-tool interactions.
* **[Immunity Agent](https://github.com/PrismorSec/immunity-agent) ⭐ 329 | 🐛 42 | 🌐 Python | 📅 2026-08-24** - Security-focused AI agent runtime for scanning prompt injection, MCP risks, unsafe package installs, and dangerous agent actions before execution.
...
* **[Checkov](https://github.com/bridgecrewio/checkov) ⭐ 8,971 | 🐛 165 | 🌐 Python | 📅 2026-08-23** - While primarily for IaC, Checkov includes policies for scanning AI infrastructure and configurations to prevent misconfigurations in deployment.
...
* **[OneCLI](https://github.com/onecli/onecli) ⭐ 3,393 | 🐛 125 | 🌐 TypeScript | 📅 2026-08-24** - Open-source credential vault for AI agents. A Rust HTTP gateway intercepts agent requests and injects API credentials transparently, so agents never handle raw keys. Supports per-agent scoped tokens and AES-256-GCM encryption at rest.

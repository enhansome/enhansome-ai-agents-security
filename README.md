...
* **[AgentGateway](https://github.com/agentgateway/agentgateway) ⭐ 4,705 | 🐛 270 | 🌐 Rust | 📅 2026-09-03** - A Linux Foundation project providing an AI-native proxy for secure connectivity (A2A & MCP protocols). It adds RBAC, observability, and policy enforcement to agent-tool interactions.
...
* **[Strix](https://github.com/usestrix/strix) ⭐ 60,357 | 🐛 346 | 🌐 Python | 📅 2026-09-03** - An autonomous AI agent designed for penetration testing. It runs inside a docker sandbox to actively probe applications and generate verified exploit capabilities.
...
* **[Garak](https://github.com/leondz/garak) ⭐ 9,102 | 🐛 408 | 🌐 Python | 📅 2026-09-03** - The "Nmap for LLMs." A vulnerability scanner that probes models for hallucination, data leakage, and prompt injection susceptibilities.
* **[Agentic Security](https://github.com/msoedov/agentic_security) ⭐ 1,984 | 🐛 73 | 🌐 Python | 📅 2026-09-01** - A dedicated vulnerability scanner for agent workflows and LLMs capable of running multi-step jailbreaks and fuzzing attacks against agent logic.
...
* **[Checkov](https://github.com/bridgecrewio/checkov) ⭐ 8,977 | 🐛 168 | 🌐 Python | 📅 2026-09-01** - While primarily for IaC, Checkov includes policies for scanning AI infrastructure and configurations to prevent misconfigurations in deployment.
...
* **[ATR (Agent Threat Rules)](https://github.com/Agent-Threat-Rule/agent-threat-rules) ⭐ 381 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-03** - 108 open-source regex detection rules for AI agent threats (prompt injection, tool poisoning, credential exfiltration, skill compromise). <1ms per scan. Adopted by Cisco AI Defense.
...
* **[OpenHands](https://github.com/All-Hands-AI/OpenHands) ⭐ 86,076 | 🐛 641 | 🌐 TypeScript | 📅 2026-09-03** - Formerly OpenDevin, this platform includes a secure runtime environment for autonomous coding agents to operate without accessing the host machine's sensitive files.
* **[Agent-Infra Sandbox](https://github.com/agent-infra/sandbox) ⭐ 5,838 | 🐛 70 | 🌐 Python | 📅 2026-08-25** - An "All-In-One" sandbox combining Browser, Shell, VSCode, and File System access in a single Docker container, optimized for agentic tasks.
* **[Kubernetes Agent Sandbox](https://github.com/kubernetes-sigs/agent-sandbox) ⭐ 3,729 | 🐛 211 | 🌐 Go | 📅 2026-09-03** - A Kubernetes Native project providing a Sandbox Custom Resource Definition (CRD) to manage isolated, stateful workloads for AI agents.
...
* **[LiteLLM Guardrails](https://github.com/BerriAI/litellm) ⭐ 57,943 | 🐛 4,957 | 🌐 Python | 📅 2026-09-03** - While known for model proxying, LiteLLM includes built-in guardrail features to filter requests and responses across multiple LLM providers.
* **[Guardrails](https://github.com/guardrails-ai/guardrails) ⭐ 7,350 | 🐛 81 | 🌐 Python | 📅 2026-09-01** - A Python framework for validating LLM outputs against structural and semantic rules (e.g., "must return valid JSON," "must not contain PII").
* **[NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,054 | 🐛 213 | 🌐 Python | 📅 2026-09-02** - NVIDIA's toolkit for adding programmable rails to LLM-based apps. It ensures agents stay on topic, avoid jailbreaks, and adhere to defined safety policies.
* **[OWASP Agent Memory Guard](https://github.com/OWASP/www-project-agent-memory-guard) ⭐ 168 | 🐛 25 | 🌐 Python | 📅 2026-09-03** - An official OWASP project that detects and blocks AI agent memory poisoning attacks (OWASP ASI06). Provides a drop-in middleware for LangChain, AutoGen, and CrewAI pipelines with real-time threat detection, sanitization hooks, and audit logging. `pip install agent-memory-guard`.

## 📊 Benchmarks & Datasets

*Resources to evaluate agent security performance.*

* **[CVE Bench](https://github.com/uiuc-kang-lab/cve-bench) ⭐ 277 | 🐛 8 | 🌐 Python | 📅 2026-01-14** - A benchmark for evaluating an AI agent's ability to exploit real-world web application vulnerabilities (useful for testing defensive agents).

## 🆔 Identity & Authentication

*Tools to manage agent identity (non-human identities).*

* **[OneCLI](https://github.com/onecli/onecli) ⭐ 3,444 | 🐛 140 | 🌐 TypeScript | 📅 2026-09-03** - Open-source credential vault for AI agents. A Rust HTTP gateway intercepts agent requests and injects API credentials transparently, so agents never handle raw keys. Supports per-agent scoped tokens and AES-256-GCM encryption at rest.
